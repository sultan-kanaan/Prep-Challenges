...
function fullName(arr) {
   let output = arr.map(arr=>`${arr.firstName} ${arr.lastName}`)
   return output;
}
// -------------------------------------------------------------------------------------------------------
...
function gradesAvg(arr) {
    let output =arr.map((arr)=>
    {arr.avg= arr.gradsList.reduce((x,y) => x+y)/arr.gradsList.length 
        return arr;
    })
    return output;
