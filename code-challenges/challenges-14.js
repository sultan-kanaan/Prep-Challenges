...
const LastWord_2 = (str) => {
    if ((str.toString().lastIndexOf(" ")) == 0) {
        ...
        const lastword = str.toString().split(" ");
...
const replaceWords = (str) => {
    const replace = str.toString().split(" ");
    if (replace[0] == "I" && replace[1] == "am") {
        replace.splice(0, 2, "We", "are");
    } 
    else {
        if (replace[0] == "I" && replace[1] == "was") {
            replace.splice(0, 2, "We", "were");
        } 
        if (replace[0] == "I") {
            replace.splice(0, 1, "We");
        }
    }
    return replace.join(" ");
}
